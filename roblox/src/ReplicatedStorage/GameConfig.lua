...
GameConfig.WEED_TIERS = {
	{ unlockLevel = 1, name = "たんぽぽ", points = 10, shape = "blade", length = 0.5, diameter = 0.12, color = Color3.fromRGB(120, 190, 90) },
	...
	{ unlockLevel = 10, name = "ススキ", points = 100, shape = "blade", length = 1.8, diameter = 0.16, color = Color3.fromRGB(200, 190, 140) },
	...
	{ unlockLevel = 13, name = "いばら", points = 130, shape = "ball", diameter = 1.0, color = Color3.fromRGB(60, 120, 60) },
