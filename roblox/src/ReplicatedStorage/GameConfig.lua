...
GameConfig.WEED_TIERS = {
	...
	{ unlockLevel = 9, name = "せいたかあわだちそう", points = 90, shape = "blade", length = 1.6, diameter = 0.18, color = Color3.fromRGB(190, 200, 90), assetId = 129817007986053 },
	{ unlockLevel = 10, name = "ススキ", points = 100, shape = "blade", length = 1.8, diameter = 0.16, color = Color3.fromRGB(200, 190, 140), assetId = 5341644421 },
	{ unlockLevel = 11, name = "アザミ", points = 110, shape = "ball", diameter = 0.9, color = Color3.fromRGB(150, 110, 170), assetId = 148015733 },
	{ unlockLevel = 12, name = "くず", points = 120, shape = "ball", diameter = 1.0, color = Color3.fromRGB(70, 140, 70), assetId = 267220625 },
	{ unlockLevel = 13, name = "いばら", points = 130, shape = "ball", diameter = 1.0, color = Color3.fromRGB(60, 120, 60), assetId = 15422478687 },
	{ unlockLevel = 14, name = "つたの茂み", points = 140, shape = "ball", diameter = 1.1, color = Color3.fromRGB(80, 150, 80), assetId = 178364498 },
	{ unlockLevel = 15, name = "低木", points = 150, shape = "ball", diameter = 1.6, color = Color3.fromRGB(50, 110, 55) },
	{ unlockLevel = 16, name = "若木", points = 160, shape = "ball", diameter = 1.8, color = Color3.fromRGB(45, 105, 50) },
	{ unlockLevel = 17, name = "切り株", points = 170, shape = "blade", length = 0.6, diameter = 0.8, color = Color3.fromRGB(120, 80, 50) },
	{ unlockLevel = 18, name = "竹", points = 180, shape = "blade", length = 2.6, diameter = 0.2, color = Color3.fromRGB(150, 190, 110) },
	{ unlockLevel = 19, name = "蔦が絡まったフェンス", points = 190, shape = "ball", diameter = 2.0, color = Color3.fromRGB(70, 130, 70) },
	{ unlockLevel = 20, name = "街路樹", points = 200, shape = "ball", diameter = 2.6, color = Color3.fromRGB(40, 100, 45) },
	{ unlockLevel = 21, name = "大きな木", points = 210, shape = "ball", diameter = 3.4, color = Color3.fromRGB(35, 95, 40) },
	{ unlockLevel = 22, name = "石垣の隙間の草", points = 220, shape = "blade", length = 0.5, diameter = 0.12, color = Color3.fromRGB(110, 170, 90) },
	{ unlockLevel = 23, name = "放置自転車の雑草", points = 230, shape = "ball", diameter = 1.4, color = Color3.fromRGB(90, 150, 80) },
	{ unlockLevel = 24, name = "電柱に絡まる蔦", points = 240, shape = "blade", length = 3.0, diameter = 0.25, color = Color3.fromRGB(70, 130, 70) },
	{ unlockLevel = 25, name = "廃屋の庭", points = 250, shape = "ball", diameter = 3.6, color = Color3.fromRGB(55, 100, 50) },
	...
	{ unlockLevel = 28, name = "一軒家", points = 280, shape = "block", size = Vector3.new(4.5, 4.5, 4.5), color = Color3.fromRGB(210, 190, 150) },
	{ unlockLevel = 29, name = "マンション", points = 290, shape = "block", size = Vector3.new(6, 10, 6), color = Color3.fromRGB(170, 170, 175) },
	{ unlockLevel = 30, name = "ビル", points = 300, shape = "block", size = Vector3.new(7, 16, 7), color = Color3.fromRGB(120, 150, 170) },
	{ unlockLevel = 31, name = "橋", points = 310, shape = "block", size = Vector3.new(10, 1.2, 3), color = Color3.fromRGB(140, 140, 140) },
	{ unlockLevel = 32, name = "電波塔", points = 320, shape = "blade", length = 12, diameter = 0.4, color = Color3.fromRGB(200, 60, 60) },
}
